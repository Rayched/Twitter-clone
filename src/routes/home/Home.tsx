...
import { AddBtnArea, AddPhotoBtn, AddPhotoInput, PostArea, SubmitBtn } from "./childrens/AddPostPage";
...
export default function Home(){
    return (
        <Wrapper>
            <PostForm>
                <H_PostArea placeholder="무슨 일이 일어나고 있나요?" />
                <H_AddBtnArea>
                    <H_AddPhotoBtn htmlFor="file">
                        <AddImageIcon w_value={35} h_value={30} />
                    </H_AddPhotoBtn>
                    <H_AddFileInput id="file" type="file" accept="image/*"/>
